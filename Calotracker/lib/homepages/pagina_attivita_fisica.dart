...
class _PaginaAttivitaFisicaState extends State<PaginaAttivitaFisica> {
  ...
  final List<_Attivita> _attivita = const [
    _Attivita(nome: 'Corsa leggera', met: 8.0, assetPath: 'assets/images/corsa.png'),
    _Attivita(nome: 'Ciclismo moderato', met: 6.8, assetPath: 'assets/images/ciclismo.png'),
    _Attivita(nome: 'Nuoto moderato', met: 6.0, assetPath: 'assets/images/nuoto.png'),
    _Attivita(nome: 'Salto con la corda', met: 10.0, assetPath: 'assets/images/corda.png'),
  ...
  Future<void> _caricaPeso() async {
    ...
    final p = prefs.getDouble(_chiavePeso) ?? prefs.getInt(_chiavePeso)?.toDouble();
          ...
          : Padding(
              ...
              child: Column(
                children: [
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color.fromARGB(255, 128, 215, 131),
                  ...
                  Expanded(
                    child: kcal <= 0
                        ? const Center(child: Text('Nessuna caloria da smaltire per oggi.'))
                        : ListView.separated(
                            itemCount: _attivita.length,
                            separatorBuilder: (_, __) => const SizedBox(height: 8),
                            itemBuilder: (context, index) {
                              final att = _attivita[index];
                              final minuti = _minutiPer(att.met, _peso, kcal).ceil();
                                ...
                                child: ListTile(
                                  leading: ClipRRect(
                                    ...
                                    child: Image.asset(
                                      ...
                                      errorBuilder: (_, __, ___) =>
                                          const Icon(Icons.image_not_supported, color: _brand),
                                    ),
                                  ),
                                  title: Text(att.nome),
                                  trailing: Text(
                                  ...
                                  onTap: () async {
                                    ...
                                    ScaffoldMessenger.of(context)
                                      ...
                                      ..showSnackBar(
                                        SnackBar(
                                          content: Text('Aggiunta: ${att.nome} ($durata)'),
